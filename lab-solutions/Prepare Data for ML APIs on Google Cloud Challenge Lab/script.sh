...
get_input "Enter the BigQuery Dataset Name:" "DATASET" 0
get_input "Enter the Cloud Storage Bucket Name:" "BUCKET" 1
get_input "Enter the table called Task 1:" "TABLE" 2
get_input "Enter the BUCKET_URL_1 Task 3:" "BUCKET_URL_1" 3
get_input "Enter the BUCKET_URL_2 Task 4:" "BUCKET_URL_2" 4
